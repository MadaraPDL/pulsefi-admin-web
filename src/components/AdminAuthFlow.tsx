...
function MFASetupPage({
  ...
  useEffect(() => {
    ...
    async function buildQrCode() {
      try {
        const dataUrl = await QRCode.toDataURL(setup.authenticator_uri, {
          ...
          <div className="pf-mfa-setup-card">
            <div className="pf-mfa-setup-header">
              ...
              <div>
                ...
                <p>
                  Scan the QR code with your authenticator app. If you cannot scan it,
                  use the secret key below for manual setup. Then enter the fresh
                  6-digit code generated by your app.
                </p>
              </div>
            </div>

            <div className="pf-authenticator-qr-card">
              {qrCodeUrl ? (
                <img
                  src={qrCodeUrl}
                  alt="Authenticator setup QR code"
                  className="pf-authenticator-qr"
                />
              ) : (
                <div className="pf-authenticator-qr-placeholder">
                  QR code unavailable
                </div>
              )}

              <p>
                Open Google Authenticator, Microsoft Authenticator, Authy, or a
                similar app, then scan this QR code. After the PulseFi entry is
                added, enter the latest 6-digit code from the app below.
              </p>
            </div>
            ...
            <div className="pf-mfa-manual-setup-box">
              <h4>Prefer manual setup?</h4>
              <ol>
                <li>Open your authenticator app.</li>
                <li>
                  Choose <strong>Add account</strong> or{" "}
                  <strong>Enter setup key</strong>.
                </li>
                <li>Copy or type the secret key exactly as shown above.</li>
                <li>
                  Select <strong>Time-based</strong> or <strong>TOTP</strong> if
                  the app asks.
                </li>
                <li>Save the entry, then enter the latest 6-digit code below.</li>
              </ol>
            </div>

            <div className="pf-mfa-helper-note">
              If you already set up PulseFi before, delete the old PulseFi entry
              in your authenticator app and use this newest QR code or secret key.
            </div>
            ...
            <p className="pf-mfa-hint">
              Need help? Scan the QR code first. If scanning is unavailable, use
            the secret key for manual setup, then enter the latest code from
